                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input value="{{old('title')}}" type="text" class="form-control bg-light @error('title') is-invalid @enderror" id="title" placeholder="Title" name="title">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{old('slug')}}" type="text" class="form-control bg-light @error('slug') is-invalid @enderror" id="slug" placeholder="Slug" name="slug">
                                @error('slug')
                                    <p class="text-danger mb-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select bg-light @error('deal') is-invalid @enderror" id="deal" name="deal">
                                    ...
                                    <option value="sale" @if(old('deal')=='sale') selected @endif>Sale</option>
                                    <option value="rent" @if(old('deal')=='rent') selected @endif>Rent</option>
                                </select>
                                @error('deal')
                                    <p class="text-danger mb-1">
                                        {{ $message }}
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('city')}}" class="form-control bg-light @error('city') is-invalid @enderror" id="city" placeholder="City" name="city">
                                    @error('city')
                                        <p class="text-danger mb-1">
                                            {{ $message }}
                                        </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('address')}}" class="form-control bg-light" id="address" placeholder="Address" name="address">
                                </div>
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input value="{{old('lat')}}" type="text" class="form-control bg-light @error('lat') is-invalid @enderror" placeholder="latitude" name="lat" id="lat" >
                                            @error('lat')
                                                <p class="text-danger mb-1">
                                                    {{ $message }}
                                                </p>
                                        ...
                                        <div class="col">
                                            ...
                                            <input value="{{old('lng')}}" type="text" class="form-control bg-light @error('lng') is-invalid @enderror" placeholder="longitude" name="lng" id="lng" >
                                            @error('lng')
                                                <p class="text-danger mb-1">
                                                    {{ $message }}
                                                </p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="number" value="{{old('bedrooms_number')}}" class="form-control bg-light @error('bedrooms_number') is-invalid @enderror" placeholder="Bedrooms number" id="bedrooms_number" name="bedrooms_number">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" value="{{old('bathrooms_number')}}" class="form-control bg-light @error('bathrooms_number') is-invalid @enderror" placeholder="Bathrooms number" id="bathrooms_number" name="bathrooms_number">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        <input value="{{old('surface')}}" type="number" class="form-control bg-light @error('surface') is-invalid @enderror" placeholder="Surface" name="surface" id="surface" >
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        <input value="{{old('price')}}" type="number" class="form-control bg-light @error('price') is-invalid @enderror" placeholder="Price" name="price" id="price" >
                                        <div class="input-group-append ">
                                            <button class="btn btn-outline-secondary text-dark" disabled >
                                                $
                                            </button>
                            ...
                            <div class="row ml-1 form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input" type="checkbox" id="garage" value="1" name="garage" @if(old('garage')) checked @endif>
                                    <label class="mt-2 ml-1" for="garage">Garage</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="security" value="1" name="security" @if(old('security')) checked @endif>
                                    <label class="mt-2 ml-1" for="security">Security</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="parking" value="1" name="parking" @if(old('parking')) checked @endif>
                                    <label class="mt-2 ml-1" for="parking">Parking</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="balcony" value="1" name="balcony" @if(old('balcony')) checked @endif>
                                    <label class="mt-2 ml-1" for="balcony">Balcony</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="swimming_pool" value="1" name="swimming_pool" @if(old('swimming_pool')) checked @endif>
                                    <label class="mt-2 ml-1" for="swimming_pool">Swimming pool</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="garden" value="1" name="garden" @if(old('garden')) checked @endif>
                                    <label class="mt-2 ml-1" for="garden">Garden</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-control-input " type="checkbox" id="terrace" value="1" name="terrace" @if(old('terrace')) checked @endif>
                ...
                <div class="col-lg-4">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-danger ml-3" href="{{route('posts')}}">Cancel</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input " type="radio" name="category" id="house" value="house" required @if(old('category')=='house') checked @endif>
                                ...
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="villa" value="villa" @if(old('category')=='villa') checked @endif>
                                        <label class="" for="villa">Villa</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="office" value="office" @if(old('category')=='office') checked @endif>
                                        <label class="" for="office">Office</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="farm" value="farm" @if(old('category')=='farm') checked @endif>
                                        <label class="" for="farm">Farm</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="land" value="land" @if(old('category')=='land') checked @endif>
                                        <label class="" for="land">Land</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="commercial_property" value="commercial_property" @if(old('category')=='commercial_property') checked @endif>
                                        <label class="" for="commercial_property">Commercial property</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="condo" value="condo" @if(old('category')=='condo') checked @endif>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="custom-select bg-light @error('condition') is-invalid @enderror" name="condition">
                                    ...
                                    <option value="to_renovate" @if(old('condition')=='to_renovate') selected @endif>To renovate</option>
                                </select>
                                @error('condition')
                                    <p class="text-danger mb-1">
                                        {{ $message }}
